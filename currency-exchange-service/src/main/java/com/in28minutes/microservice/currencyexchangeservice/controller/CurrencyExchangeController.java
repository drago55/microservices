...
import com.in28minutes.microservice.currencyexchangeservice.bean.TestResponse;
import com.in28minutes.microservice.currencyexchangeservice.repository.ExchangeValueRepository;
...
public class CurrencyExchangeController {
	...
	public TestResponse testControlerForCurrency() {
		return new TestResponse("This is a test");
	}
